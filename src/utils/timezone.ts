// FIXME: When next is updated to >= 18, this will be available via Intl API
export const allTimezones = [
	...
	},
	{
		...
		'offset': 0,
		'isdst': true,
		'text': '(UTC) Dublin, Lisbon, Edinburgh, London, Monrovia, Reykjavik',
		'utc': [
			'Europe/Lisbon',
			'Europe/Dublin',
			'Atlantic/Canary',
